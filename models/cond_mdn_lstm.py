...
class condMdnLSTM(nn.Module):
    ...
    def forward(self, cond_input, xt, h1_tm1, c1_tm1, h2_tm1, c2_tm1):
        cond_input = torch.cat(cond_input, xt)
        tinput = self.input(cond_input)
        h1_t, c1_t = self.lstm1(tinput, (h1_tm1, c1_tm1))
