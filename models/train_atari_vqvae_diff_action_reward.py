...
def init_train():
    ...
    valid_data_file = train_data_file.replace('train', 'test')
    ...
    info['num_rewards'] = len(train_data_loader.reward_space)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_file', default='/usr/local/data/jhansen/planning/model_savedir/MBBreakout_init_dataset/train_set.npz')
    parser.add_argument('-c', '--cuda', action='store_true', default=False)
    #parser.add_argument('--savename', default='vqdiffactintreward')
    parser.add_argument('--savename', default='BreakoutVQ')
